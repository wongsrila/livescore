...
async function requestLivescores() {
  try {
    ...
    const response = await fetch(
      `https://api.sportmonks.com/v3/football/fixtures/date/20${getDate}?&include=round;league.country;scores;events;participants;periods;state.type&timezone=Europe/Amsterdam`,
      {
        method: 'GET',
        headers: {
